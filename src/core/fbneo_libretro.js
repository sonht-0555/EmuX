...
var wasmBinaryFile;
  wasmBinaryFile = 'fbneo_libretro.wasm';
...
// end include: preamble.js
  ...
  try {
      ...
      while (idx < stream.getdents.length && pos + struct_size <= count) {
        ...
        assert(id);
        (tempI64 = [id>>>0,(tempDouble=id,(+(Math.abs(tempDouble))) >= 1.0 ? (tempDouble > 0.0 ? (+(Math.floor((tempDouble)/4294967296.0)))>>>0 : (~~((+(Math.ceil((tempDouble - +(((~~(tempDouble)))>>>0))/4294967296.0)))))>>>0) : 0)], HEAP32[((dirp + pos)>>2)] = tempI64[0],HEAP32[(((dirp + pos)+(4))>>2)] = tempI64[1]);checkInt64(id);
        (tempI64 = [(idx + 1) * struct_size>>>0,(tempDouble=(idx + 1) * struct_size,(+(Math.abs(tempDouble))) >= 1.0 ? (tempDouble > 0.0 ? (+(Math.floor((tempDouble)/4294967296.0)))>>>0 : (~~((+(Math.ceil((tempDouble - +(((~~(tempDouble)))>>>0))/4294967296.0)))))>>>0) : 0)], HEAP32[(((dirp + pos)+(8))>>2)] = tempI64[0],HEAP32[(((dirp + pos)+(12))>>2)] = tempI64[1]);checkInt64((idx + 1) * struct_size);
        HEAP16[(((dirp + pos)+(16))>>1)] = 280;checkInt16(280);
        HEAP8[(((dirp + pos)+(18))>>0)] = type;checkInt8(type);
  ...
  /** @type {function(...*):?} */
  function _dirent_vfs_init(
  ) {
  abort('missing function: dirent_vfs_init');
  }
  _dirent_vfs_init.stub = true;
  ...
  /** @type {function(...*):?} */
  function _path_is_valid(
  ) {
  abort('missing function: path_is_valid');
  }
  _path_is_valid.stub = true;

  /** @type {function(...*):?} */
  function _path_vfs_init(
  ) {
  abort('missing function: path_vfs_init');
  }
  _path_vfs_init.stub = true;

  /** @type {function(...*):?} */
  function _retro_dirent_error(
  ) {
  abort('missing function: retro_dirent_error');
  }
  _retro_dirent_error.stub = true;

  /** @type {function(...*):?} */
  function _rfeof(
  ) {
  abort('missing function: rfeof');
  }
  _rfeof.stub = true;
  ...
  abort('missing function: rferror');
  }
  _rferror.stub = true;
...
var wasmImports = {
  ...
  abort: _abort,
  /** @export */
  dirent_vfs_init: _dirent_vfs_init,
  /** @export */
  ...
  fd_write: _fd_write,
  /** @export */
  filestream_exists: _filestream_exists,
  /** @export */
  filestream_vfs_init: _filestream_vfs_init,
  /** @export */
  path_is_valid: _path_is_valid,
  /** @export */
  path_vfs_init: _path_vfs_init,
  /** @export */
  retro_dirent_error: _retro_dirent_error,
  /** @export */
  rfeof: _rfeof,
  /** @export */
  rferror: _rferror,
...
var _retro_set_video_refresh = Module['_retro_set_video_refresh'] = createExportWrapper('retro_set_video_refresh');
var _retro_set_audio_sample = Module['_retro_set_audio_sample'] = createExportWrapper('retro_set_audio_sample');
var _retro_set_audio_sample_batch = Module['_retro_set_audio_sample_batch'] = createExportWrapper('retro_set_audio_sample_batch');
var _retro_set_environment = Module['_retro_set_environment'] = createExportWrapper('retro_set_environment');
var _retro_get_system_av_info = Module['_retro_get_system_av_info'] = createExportWrapper('retro_get_system_av_info');
var _retro_init = Module['_retro_init'] = createExportWrapper('retro_init');
var _retro_deinit = Module['_retro_deinit'] = createExportWrapper('retro_deinit');
var _retro_run = Module['_retro_run'] = createExportWrapper('retro_run');
var _retro_load_game = Module['_retro_load_game'] = createExportWrapper('retro_load_game');
var _retro_unload_game = Module['_retro_unload_game'] = createExportWrapper('retro_unload_game');
...
var _string_to_lower = Module['_string_to_lower'] = createExportWrapper('string_to_lower');
var _string_replace_substring = Module['_string_replace_substring'] = createExportWrapper('string_replace_substring');
var _malloc = Module['_malloc'] = createExportWrapper('malloc');
var _find_last_slash = Module['_find_last_slash'] = createExportWrapper('find_last_slash');
var _path_basename = Module['_path_basename'] = createExportWrapper('path_basename');
var _path_parent_dir = Module['_path_parent_dir'] = createExportWrapper('path_parent_dir');
var _path_is_absolute = Module['_path_is_absolute'] = createExportWrapper('path_is_absolute');
var _path_remove_extension = Module['_path_remove_extension'] = createExportWrapper('path_remove_extension');
var _path_get_extension = Module['_path_get_extension'] = createExportWrapper('path_get_extension');
var _path_mkdir = Module['_path_mkdir'] = createExportWrapper('path_mkdir');
var _path_is_directory = Module['_path_is_directory'] = createExportWrapper('path_is_directory');
var _retro_opendir_include_hidden = Module['_retro_opendir_include_hidden'] = createExportWrapper('retro_opendir_include_hidden');
var _retro_readdir = Module['_retro_readdir'] = createExportWrapper('retro_readdir');
var _retro_dirent_get_name = Module['_retro_dirent_get_name'] = createExportWrapper('retro_dirent_get_name');
...
var _filestream_seek = Module['_filestream_seek'] = createExportWrapper('filestream_seek');
...
var _retro_vfs_file_get_size_impl = Module['_retro_vfs_file_get_size_impl'] = createExportWrapper('retro_vfs_file_get_size_impl');
var _retro_vfs_file_read_impl = Module['_retro_vfs_file_read_impl'] = createExportWrapper('retro_vfs_file_read_impl');
var _retro_vfs_file_write_impl = Module['_retro_vfs_file_write_impl'] = createExportWrapper('retro_vfs_file_write_impl');
var _retro_vfs_file_seek_impl = Module['_retro_vfs_file_seek_impl'] = createExportWrapper('retro_vfs_file_seek_impl');
var _retro_vfs_file_tell_impl = Module['_retro_vfs_file_tell_impl'] = createExportWrapper('retro_vfs_file_tell_impl');
