...
// end include: preamble.js
  ...
  /** @type {function(...*):?} */
  function _intfstream_open_file(
  ) {
  ...
  /** @type {function(...*):?} */
  function _intfstream_open_rzip_file(
  ) {
  ...
  /** @type {function(...*):?} */
  function _path_remove_extension(
  ) {
...
var wasmImports = {
  ...
  abort: _abort,
  /** @export */
  cpu_read32: _cpu_read32,
  /** @export */
  cpu_read8: _cpu_read8,
  /** @export */
  cpu_write32: _cpu_write32,
  /** @export */
  cpu_write8: _cpu_write8,
  /** @export */
  ...
  /** @export */
  intfstream_close: _intfstream_close,
  /** @export */
  intfstream_gets: _intfstream_gets,
  /** @export */
  intfstream_open_file: _intfstream_open_file,
  /** @export */
  intfstream_open_rzip_file: _intfstream_open_rzip_file,
  /** @export */
  intfstream_read: _intfstream_read,
  /** @export */
  intfstream_rewind: _intfstream_rewind,
  /** @export */
  intfstream_write: _intfstream_write,
  /** @export */
  path_basedir: _path_basedir,
  /** @export */
  path_basename: _path_basename,
  /** @export */
  path_is_directory: _path_is_directory,
  /** @export */
  path_is_valid: _path_is_valid,
  /** @export */
  path_mkdir: _path_mkdir,
  /** @export */
  path_remove_extension: _path_remove_extension
};
