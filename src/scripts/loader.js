        ...
        window.Module = {
            ...
            async onRuntimeInitialized() {
                ...
                function mainLoop() {
                    ...
                    if (!window._lastModeLog || Date.now() - window._lastModeLog > 5000) {
                        console.log("%c[Engine] Mode: SINGLE PLAYER (Audio-Driven)", "color: #44ff44; font-weight: bold");
                        window._lastModeLog = Date.now();
                    }
