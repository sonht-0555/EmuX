...
const color_list = [
    "#AB5130", "#4C6885", "#F0B541", "#63AB3F",
    "#FF7AAE", "#2F5753", "#692464", "#E64539",
    "#C8D45D", "#4FA4B8", "#DFE0E8", "#A3A7C2",
    "#686F99", "#404973", "#2C354D", "#3D2936",
    "#52333F", "#8F4D57", "#BD6A62", "#92E8C0",
    "#CC2F7B", "#FF8933",
];

const ui_color_list = [
    "#4C6885", "#2F5753", "#A3A7C2", "#404973", "#2C354D",
];
